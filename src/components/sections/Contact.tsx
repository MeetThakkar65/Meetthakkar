...
const WhatsAppIcon = () => (
  <svg 
    ...
    viewBox="0 0 24 24" 
    fill="currentColor" 
    className="flex-shrink-0" // Prevents the icon from squishing on mobile
  >
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <motion.div className="glass p-8 md:p-12 rounded-[3rem] border-white/10 shadow-2xl relative">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
  type="submit" 
  className="w-full bg-accent hover:bg-hoverAccent text-white py-5 px-6 rounded-2xl font-bold text-lg transition-all shadow-lg shadow-accent/20 flex items-center justify-center gap-4 group active:scale-[0.98] relative overflow-hidden"
>
  {/* The Icon and Text now live in a stable Flex container */}
  <div className="flex items-center gap-3 relative z-10">
    <WhatsAppIcon />
    <span className="leading-tight">Send Message via WhatsApp</span>
  </div>
